...
allFiles = ['affinecipher.py', 'alphabetizequiz.py', 'alphabetizewordquiz.py', 'analogclock.py', 'bagels.py',
'barca.py', 'birthdayparadox.py', 'bitmapmessage.py', 'blackjack.py',
'bouncingdots.py', 'bouncingdvd.py', 'bouncinglines.py', 'caesarcipher.py', 'caesarhacker.py', 'calendarmaker.py',
'carrotinabox.py', 'chancecheckers.py',
'checkers.py', 'chohan.py', 'chomp.py', 'clickbait.py', 'coinflipsimulator.py', 'collatz.py', 'collatzstats.py',
'conwaysgameoflife.py', 'conwaysgameoflife2.py',
'countdown.py', 'countingquiz.py', 'deepcave.py', 'diagonalmaze.py', 'diamonds.py', 'dicemath.py', 'diceroller.py', 'digitalclock.py',
'digitalstream.py', 'dna.py', 'ducklings.py', 'eenymeeny.py', 'etchingdrawer.py', 'factorfinder.py', 'fastdraw.py', 'fibonacci.py',
'fireflies.py', 'fishtank.py', 'fizzbuzz.py', 'fizzbuzzgame.py', 'flooder.py', 'floorpainters.py',
'forestfiresim.py', 'fourinarow.py', 'fractalnonuniformtree.py', 'fractaltree.py', 'ghostleglottery.py', 'gomoku.py',
'guess.py', 'guillotine.py', 'gullible.py', 'hacking.py', 'hammurabi.py', 'hamsburger.py', 'hangman.py',
'hangmanunfair.py', 'hardcodedtictactoe.py', 'hexapawn.py', 'hexgrid.py', 'hilbertcurve.py',
'hourglass.py', 'hungryrobots.py', 'jaccuse.py', 'kaprekarnumbers.py', 'kochsnowflake.py', 'langtonsant.py', 'lawnmower.py', 'leetspeak.py',
'lostkitty.py', 'luckystars.py', 'luhn.py', 'magicfortuneball.py', 'magichexagon.py', 'mancala.py', 'matchingparens.py', 'mazemakerrec.py',
'mazerunner2d.py', 'mazerunner3d.py', 'middleletterscrambler.py', 'milliondicestats.py', 'monalisa.py', 'mondrian.py',
'montyhall.py',
'morsecode.py', 'multiplicationtable.py', 'multiplicativepersistence.py', 'ninetyninebottles.py', 'ninetyninebottles2.py', 'numeralsystems.py',
'parkingvalet.py', 'pegsolitaire.py', 'periodictable.py', 'piglatin.py', 'polygons.py', 'powerballlottery.py', 'primenumbers.py',
'progressbar.py', 'pythons.py', 'railfencecipher.py', 'rainbow.py', 'rainbow2.py', 'randomwalk.py', 'reversegam.py', 'rockpaperscissors.py',
'rockpaperscissorsalwayswin.py', 'rot13cipher.py', 'rotatingcube.py', 'royalgameofur.py', 'sandsimulator.py', 'sevseg.py', 'shellgame.py',
'shimmer.py',
'shiningcarpet.py', 'sierpinskisgame.py', 'sierpinskisquare.py', 'sierpinskitriangle.py', 'simplesubcipher.py', 'sinemessage.py', 'slidingtilepuzzle.py', 'slitheringsnakes.py',
'snailrace.py', 'sokoban.py', 'sonar.py', 'soroban.py', 'soundmimic.py', 'spongecase.py', 'squiggles.py', 'sudoku.py', 'texttospeechtalker.py',
'threecardmonte.py', 'tictactoe.py', 'tictactoeoop.py', 'towerofhanoi.py', 'trickquestions.py', 'turtledemowrapper.py',
'twentyfortyeight.py', 'ulamspiral.py', 'ultimatetictactoe.py', 'vacuumbot.py', 'vigenerecipher.py', 'waterbucket.py', 'zigzag.py']
