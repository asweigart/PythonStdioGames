...
PROGRAMS = [   {   'desc': 'A time-based quiz game to see how fast you can alphabetize letters.',
    ...
    {'desc': 'An analog clock animation.', 'filename': 'analogclock.py', 'hash': 1469112176, 'name': 'Analog Clock'},
    ...
    {   'desc': 'A card game also known as 21. More info at: https://en.wikipedia.org/wiki/Blackjack',
        ...
        'hash': 849137676,
        'name': 'Blackjack'},
    {'desc': 'A bouncing ball animation.', 'filename': 'bouncingDots.py', 'hash': 900378946, 'name': 'Bouncing Ball'},
    ...
    {   'desc': 'A board game to get four tiles in a row.',
        ...
        'hash': 1282552112,
        'name': 'Connect Four'},
    {   'desc': 'The classic cellular automata simulation. More info at: '
    ...
    {   'desc': 'Show a countdown timer animation using a seven-segment display. More info at '
    ...
    {   'desc': 'Simulates dice rolls using the Dungeons & Dragons notation.',
        ...
        'hash': 800095226,
        'name': 'Dice Roller'},
    {   'desc': 'Display a digital clock of the current time with a seven-segment display. More info at '
                'https://en.wikipedia.org/wiki/Seven-segment_display Requires our sevseg.py program.',
        'filename': 'digitalclock.py',
        'hash': 910967291,
        'name': 'Digital Clock'},
    {   'desc': 'A simple animation of a DNA double-helix. Thanks to matoken for inspiration: '
                'https://asciinema.org/a/155441',
        'filename': 'dna.py',
        'hash': 3297633959,
        'name': 'DNA'},
    {   'desc': 'An elimination game for multiple players. More info at '
    ...
    {   'desc': 'Find all the factors of a number.',
        ...
        'hash': 1692605437,
        'name': 'Factorization'},
    {'desc': 'A beautiful animation of fireflies.', 'filename': 'fireflies.py', 'hash': 946397354, 'name': 'Fireflies'},
    ...
    {   'desc': 'A colorful game where you try to fill the board with a single color.',
        ...
        'hash': 3502757288,
        'name': 'Flood It!'},
    {   'desc': "A simulation of fires spreading in a growing forest. Inspired by Nicky Case's Emoji Sim "
    ...
    {   'desc': 'Draws a Koch snowflake fractal with turtle graphics.',
        ...
        'hash': 2197153980,
        'name': 'Koch Snowflake'},
    {   'desc': 'A cellular automata animation. More info: https://en.wikipedia.org/wiki/Langton%27s_ant',
        'filename': 'langtonsant.py',
        'hash': 1185180756,
        'name': "Langton's Ant"},
    {   'desc': 'Watch grass get cut and grow again. Inspired by Tondeuse by Jules Villard, '
    ...
    {   'desc': 'A sample progress bar animation that can be used in other programs.',
        ...
        'hash': 3281085795,
        'name': 'Progress Bar'},
    {'desc': 'Drawing pythons with turtle graphics.', 'filename': 'pythons.py', 'hash': 3410529509, 'name': 'Pythons'},
    {   'desc': 'The "rail fence" cipher for encrypting text. More info at: '
                'https://en.wikipedia.org/wiki/Rail_fence_cipher',
        'filename': 'railfencecipher.py',
        'hash': 39302442,
        'name': 'Rail Fence Cipher'},
    {'desc': 'Shows a simple rainbow animation.', 'filename': 'rainbow.py', 'hash': 734690400, 'name': 'Rainbow'},
    {   'desc': 'Shows a simple squiggle rainbow animation.',
        'filename': 'rainbow2.py',
        'hash': 3080998533,
        'name': 'Rainbow 2'},
    {   'desc': 'Generate splatter-art with the "random walk" algorithm. More info at: '
    ...
    {   'desc': 'The simplest cipher for encrypting and decrypting text. More info at '
        ...
        'hash': 2777215909,
        'name': 'ROT13 Cipher'},
    {'desc': 'A rotating cube animation.', 'filename': 'rotatingcube.py', 'hash': 3029480390, 'name': 'Rotating Cube'},
    ...
    {'desc': 'A simple zig zag animation.', 'filename': 'zigzag.py', 'hash': 761514846, 'name': 'Zigzag'}]
